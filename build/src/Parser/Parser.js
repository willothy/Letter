...
class Parser {
    ...
    constructor(combineFiles = false) {
        ...
        this._preprocessor = new Preprocessor_1.default();
     ...
     */
    Program() {
        return ASTFactory_1.default.Program(this.StatementList());
    }
    /**
     *  StatementList
     *      : Statement
    ...
    ClassDeclaration() {
        ...
        return ASTFactory_1.default.ClassDeclaration(id, superClass, body);
    }
    /**
     *  ClassExtends
     */
    ...
    FunctionDeclaration() {
        ...
        return ASTFactory_1.default.FunctionDeclaration(name, type, params, body);
    }
    ExternDeclaration() {
        this._eat('extern');
        const type = this.Type();
        ...
        this._eat(')');
        this._eat(';');
        return ASTFactory_1.default.ExternDeclaration(name, type, params);
    }
    /**
     *  FormalParameterList
     *      : Identifier
    ...
    ReturnStatement() {
        ...
        this._eat(';');
        return ASTFactory_1.default.ReturnStatement(argument);
    }
    /**
     *  IterationStatement
     *      : WhileStatement
    ...
    WhileStatement() {
        ...
        this._eat(')');
        const body = this.Statement();
        return ASTFactory_1.default.WhileStatement(test, body);
    }
    /**
     *  DoWhileStatement
    ...
    DoWhileStatement() {
        ...
        this._eat(')');
        this._eat(';');
        return ASTFactory_1.default.DoWhileStatement(body, test);
    }
    /**
     *  ForStatement
    ...
    ForStatement() {
        ...
        this._eat(')');
        const body = this.Statement();
        return ASTFactory_1.default.ForStatement(init, test, update, body);
    }
    /**
     *  ForStatementInit
    ...
    IfStatement() {
        ...
        return ASTFactory_1.default.IfStatement(test, consequent, alternate);
    }
    /**
     *  VariableStatementInit
    ...
    VariableStatementInit() {
        ...
        return ASTFactory_1.default.VariableStatement(declarations);
    }
    /**
     *  VariableStatement
     *      : 'let' VariableDeclarationList ';'
    ...
    VariableDeclaration() {
        ...
        return ASTFactory_1.default.VariableDeclaration(id, type, init);
    }
    /**
     *      Type
     *      : TYPE
    ...
    Type() {
        ...
        return ASTFactory_1.default.Type(baseType, typeStr, arrayType, dimensions);
    }
    /**
     *  VariableInitializer
    ...
    EmptyStatement() {
        this._eat(';');
        return ASTFactory_1.default.EmptyStatement();
    }
    /**
     *  BlockStatement
     *      : '{' OptStatementList '}'
    ...
    BlockStatement() {
        ...
        this._eat('}');
        return ASTFactory_1.default.BlockStatement(body);
    }
    /**
     *  ExpressionStatement
     *      : Expression ';'
    ...
    ExpressionStatement() {
        ...
        this._eat(';');
        return ASTFactory_1.default.ExpressionStatement(expression);
    }
    /**
     *  Expression
     *      : Literal
    ...
    AssignmentExpression() {
        ...
        return ASTFactory_1.default.AssignmentExpression(this.AssignmentOperator().value, this._checkValidAssignmentTarget(left), this.AssignmentExpression());
    }
    /**
     *  EqualityExpression
    ...
    Identifier() {
        ...
        return ASTFactory_1.default.Identifier(name);
    }
    /**
    ...
    _LogicalExpression(builderName, operatorToken) {
        ...
        while (this._lookahead.type === operatorToken) {
            ...
            left = ASTFactory_1.default.LogicalExpression(operator, left, right);
        }
        return left;
    }
    /**
    ...
    _BinaryExpression(builderName, operatorToken) {
        ...
        while (this._lookahead.type === operatorToken) {
            ...
            const operator = this._eat(operatorToken).value;
            const right = this[builderName]();
            left = ASTFactory_1.default.BinaryExpression(operator, left, right);
        }
        return left;
    }
    /**
    ...
    UnaryExpression() {
        ...
        if (operator != null) {
            return ASTFactory_1.default.UnaryExpression(operator, this.UnaryExpression());
        }
    ...
    _CallExpression(callee) {
        let callExpression = ASTFactory_1.default.CallExpression(callee, this.Arguments());
        if (this._lookahead.type === '(') {
    ...
    MemberExpression() {
        ...
        while (this._lookahead.type === '.' || this._lookahead.type === '[') {
            ...
            if (this._lookahead.type === '.') {
                ...
                object = ASTFactory_1.default.MemberExpression(false, object, property);
            }
            // MemberExpression '[' Expression ']'
            if (this._lookahead.type === '[') {
                this._eat('[');
                ...
                this._eat(']');
                object = ASTFactory_1.default.MemberExpression(true, object, property);
            }
        }
        return object;
    }
    ...
    NewExpression() {
        ...
        return ASTFactory_1.default.NewExpression(callee, args);
    }
    /**
     *  ThisExpression
     *      : 'this'
    ...
    ThisExpression() {
        this._eat('this');
        return ASTFactory_1.default.ThisExpression();
    }
    /**
     *  Super
     *      : 'super'
    ...
    Super() {
        this._eat('super');
        return ASTFactory_1.default.Super();
    }
    /**
    ...
    CharLiteral() {
        ...
        return ASTFactory_1.default.CharLiteral(token.value.slice(1, -1));
    }
    /**
     *  BooleanLiteral
     *      : 'true'
    ...
    BooleanLiteral(value) {
        ...
        return ASTFactory_1.default.BooleanLiteral(value);
    }
    /**
     *  BooleanLiteral
     *      : 'null'
    ...
    NullLiteral() {
        this._eat('null');
        return ASTFactory_1.default.NullLiteral();
    }
    /**
     *  StringLiteral
     *      : STRING
    ...
    StringLiteral() {
        ...
        return ASTFactory_1.default.StringLiteral(token.value.slice(1, -1));
    }
    /**
     *  NumericLiteral
     *      : NUMBER
    ...
    _eat(tokenType) {
        ...
        if (token == null) {
            throw new SyntaxError(`Unexpected end of input, expected: "${tokenType}", last: "${JSON.stringify(this._last, null, 2)}", next: ${JSON.stringify(this._tokenizer.exec()[0])}`);
        }
        if (token.type !== tokenType) {
            throw new SyntaxError(`Unexpected token: "${token.value}", expected: "${tokenType}", last: "${JSON.stringify(this._last, null, 2)}", next: ${JSON.stringify(this._tokenizer.exec()[0])}`);
        }
